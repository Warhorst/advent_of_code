...
use crate::y2023::d20::{solve_20a, solve_20b};
use crate::y2023::d21::{solve_21a, solve_21b};
...
fn solve_day(day: usize) {
    let solve_day_funcs = [
        ...
        || solve(20, 2023, solve_20a, 32000000, solve_20b, 1),
        || solve(21, 2023, solve_21a, 16, solve_21b, 0),
    ];
